<div class="demo-headline">
      ...
      <div class="demo-row typography-row">
      	...
      	<div class="demo-content">
	          ...
	          <img src="../resources/img/example-image.jpg" alt="example-image" class="img-rounded img-responsive">
      ...
      <div class="demo-illustrations">
        <div class="demo-content">
          <div><img src="../resources/img/icons/svg/toilet-paper.svg" alt="Toilet-Paper"></div>
          <div><img src="../resources/img/icons/svg/gift-box.svg" alt="Gift-Box"></div>
          <div><img src="../resources/img/icons/svg/pencils.svg" alt="Pensils"></div>
          <div><img src="../resources/img/icons/svg/clipboard.svg" alt="Clipboard"></div>
          <div><img src="../resources/img/icons/svg/retina.svg" alt="Retina"></div>
          <div><img src="../resources/img/icons/svg/compas.svg" alt="Compas"></div>
          <div><img src="../resources/img/icons/svg/map.svg" alt="Map"></div>
          <div><img src="../resources/img/icons/svg/chat.svg" alt="Chat"></div>
          <div><img src="../resources/img/icons/svg/mail.svg" alt="Mail"></div>
          <div><img src="../resources/img/icons/svg/book.svg" alt="Book"></div>
          <div><img src="../resources/img/icons/svg/calendar.svg" alt="Calendar"></div>
          <div><img src="../resources/img/icons/svg/paper-bag.svg" alt="Pocket"></div>
          <div><img src="../resources/img/icons/svg/clocks.svg" alt="Watches"></div>
          <div><img src="../resources/img/icons/svg/loop.svg" alt="Infinity-Loop"></div>
        </div>
      </div>
      ...
      <div class="row demo-samples">
        ...
        <div class="col-xs-8">
          <video class="video-js" preload="auto" poster="../resources/img/video/poster.jpg" data-setup="{}">
      ...
      <div class="login">
        <div class="login-screen">
          <div class="login-icon">
            <img src="../resources/img/login/icon.png" alt="Welcome to Mail App" />
      ...
      <div class="row">
        <div class="col-xs-9">
          <div class="demo-browser">
            ...
            <div class="demo-browser-content">
              <img src="../resources/img/demo/browser-pic-1.jpg" alt="" />
              <img src="../resources/img/demo/browser-pic-2.jpg" alt="" />
              <img src="../resources/img/demo/browser-pic-3.jpg" alt="" />
              <img src="../resources/img/demo/browser-pic-4.jpg" alt="" />
              <img src="../resources/img/demo/browser-pic-5.jpg" alt="" />
              <img src="../resources/img/demo/browser-pic-6.jpg" alt="" />
            </div>
          </div>
        </div>
        ...
        <div class="col-xs-3">
          <div class="demo-download">
            <img src="../resources/img/demo/html-icon.png" src="Free PSD" />
          </div>
